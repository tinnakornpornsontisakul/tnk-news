  ...
  stories: [
    ...
    },
    {
      ...
      th: {
        ...
        body: "SBI Securities และ Daiwa Securities กำลังพัฒนาแพลตฟอร์มชำระราคาให้ผู้ลงทุนต่างชาติซื้อ security token ของญี่ปุ่นได้ โดยเริ่มที่สิงคโปร์เป็นตลาดแรก และชำระราคาด้วย Stablecoin USDC (อาจเพิ่มเยนแบบ Stablecoin ภายหลัง) สร้างบนบล็อกเชน BOOSTRY — เลือกแทน Progmat — โครงการได้รับการรับรองจาก Japan Securities Dealers Association ตั้งเป้าเปิดใช้ปี 2027 ครอบคลุมอสังหาริมทรัพย์ หุ้นกู้ ไปจนถึง Token สายอนิเมะและสาเก",
    ...
    // ---------- SET (Thai capital market — digital assets only) ----------
    {
      ...
      th: {
        ...
        body: "Blu Green Token (BLU) ของ DITTO — Token เพื่อการลงทุนหนุนด้วยคาร์บอนเครดิตตัวแรกของไทย — อยู่ในช่วงเปิดจองสดสัปดาห์นี้ ผ่านแอป Token X ตั้งแต่ 3 ก.ค. ถึง 13 ก.ค. เวลา 15.30 น. ที่ราคา ฿1.20 ต่อโทเคน (ไม่เกิน ฿480 ล้าน) ออกโดย Siam TC Technology บริษัทย่อยของ DITTO มี InnovestX เป็นตัวแทน หนุนหลังด้วยป่าชายเลน 17,531 ไร่ที่ขึ้นทะเบียน T-VER และ Premium T-VER ตั้งเป้า IRR กรณีฐาน 10.35% พร้อมการันตีขั้นต่ำ 3%",
